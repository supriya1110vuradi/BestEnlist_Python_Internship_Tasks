#Create a real time scenario for inheritance example Bankaccount class with deposit, withdraw function.
...
# code for a banking project in Python. The following program has these features:
...
class Account :
   ...
   def createAccount(self):
       ...
       self.accNo= int(input("Enter the new account no : "))
